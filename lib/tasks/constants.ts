...
export const CONTENT_TYPES: { value: string; label: string; credits: number; minLeadHours: number }[] = [
  ...
  { value: "graphics", label: "Graphics", credits: 1, minLeadHours: 0 },
  { value: "image_with_graphics", label: "Image (with graphics)", credits: 2, minLeadHours: 0 },
  { value: "image", label: "Image", credits: 1, minLeadHours: 0 },
  { value: "ai_image_with_graphics", label: "AI image (with graphics)", credits: 1, minLeadHours: 0 },
  { value: "stories_3", label: "3x stories", credits: 1, minLeadHours: 0 },
  { value: "stories_12", label: "12x stories", credits: 3, minLeadHours: 0 },
